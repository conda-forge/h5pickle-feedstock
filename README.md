About h5pickle-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/h5pickle-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2990&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/h5pickle-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `h5pickle` can be installed with `conda`:
...
```
mamba install h5pickle
```

It is possible to list all of the versions of `h5pickle` available on your platform with `conda`:
...
```
mamba search h5pickle --channel conda-forge
```
...
mamba repoquery search h5pickle --channel conda-forge

# List packages depending on `h5pickle`:
mamba repoquery whoneeds h5pickle --channel conda-forge

# List dependencies of `h5pickle`:
mamba repoquery depends h5pickle --channel conda-forge
```
